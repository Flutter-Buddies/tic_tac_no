...
static const Map<String,dynamic> cs = {
  "game": {
    ...
    "player_no_name": "Bez jména",
    "return_to_game": "VRÁTIT SE DO HRY",
    "quit_to_menu": "ZPĚT DO MENU",
    "win": "vyhrává!",
    "thinking": "Přemýšlí..."
  },
  "menu": {
    "coming_soon": "Již brzy!",
    "searching_for_game": "Vyhledávání hry...",
    "you": "TY",
    "how_to_play": "Nápověda",
    "hard": "TĚŽKÁ",
    "medium": "STŘEDNÍ",
    "online_multiplayer": "HRA PRO VÍCE HRÁČŮ",
    "local_multiplayer_setup": "NASTAVENÍ LOKÁLNÍ HRY",
    "local_multiplayer": "LOKÁLNÍ HRA",
    "easy": "LEHKÁ",
    "change_language": "Jazyk",
    "ai": "Počítač",
    "player_1": "HRÁČ 1",
    "player_2": "HRÁČ 2",
    "single_player_setup": "NASTAVENÍ HRY JEDNOHO HRÁČE",
    "single_player": "JEDEN HRÁČ",
    "start_game": "ZAČÍT HRU",
    "online_multiplayer_setup": "NASTAVENÍ HRY VÍCE HRÁČŮ"
  },
  "rules": {
    "start": "Začít",
    ...
    "one_more_thing": "Zní to jednoduše? Je tu ještě jedna věc ... tah na vnitřním poli určuje pozici dalšího herního pole na herní desce pro vašeho soupeře."
  },
  "global": {
    "app_name": "Tic-Tac-No"
  }
...
static const Map<String,dynamic> zh = {
  ...
  "game": {
    "are_you_sure_quit": "你確定要退出嗎？",
    "all_progress_lost": "你將遺失所有進度。",
    "quit_game": "離開遊戲",
    "return_to_game": "回到遊戲中",
    "quit_to_menu": "回到選單",
    "play_again": "再玩一次",
    "win": "勝出!",
    "wins": "勝出!",
  ...
  "menu": {
    "online_multiplayer": "線上多人玩家",
    "coming_soon": "敬請期待!",
    "how_to_play": "遊戲指南",
    "easy": "簡單",
    "medium": "中等",
    "hard": "困難",
    "single_player_setup": "單人玩家設置",
    "local_multiplayer_setup": "本機多人玩家設置",
    "online_multiplayer_setup": "線上多人玩家設置",
    "searching_for_game": "尋找遊戲...",
    "you": "你",
    "player_1": "玩家 1",
    "player_2": "玩家 2",
    "ai": "AI",
    "start_game": "開始遊戲",
    "local_multiplayer": "本地多人玩家",
    "single_player": "單人玩家",
    "change_language": "語言設置"
  },
  "rules": {
    "rules": "規則",
    "previous": "之前",
    ...
    "start": "開始",
    "good_luck": "祝你好運!",
    "tic_must_win": "首先你必須在一般的圈圈叉叉遊戲中勝出。",
